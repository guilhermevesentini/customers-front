...
export const phoneRules = [
  ...
  (value: string) =>
    /^\(?\d{2}\)?\s?\d{4,5}-?\d{4}$/.test(value) || 'Phone must be a valid format (e.g., (00) 00000-0000).',
]
...
export const statusRules = [
  (value: string | null | undefined) => !!value || 'Status is required.',
]

export const tipoRules = [
  (value: string | null | undefined) => !!value || 'Tipo is required.',
]
...
export const priceRules = [
  (value: string | null | undefined) => value !== null && value !== undefined && value !== '0' || 'Price is required.',
